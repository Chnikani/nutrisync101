...
??? question "What are the best models for prismix.new?"
For the best experience with prismix.new, we recommend using the following models from our 19 supported providers:
...
prismix.new uses a modular provider architecture. To add a new provider:
...
prismix.new provides multiple ways to access help and documentation:
...
??? question "How do I get the best results with prismix.new?"
...
MCP extends prismix.new's AI capabilities with external tools:
...
??? question "How do I deploy my prismix.new projects?"
prismix.new supports one-click deployment to multiple platforms:
...
prismix.new provides comprehensive Git and GitHub integration:
...
??? question "How do I contribute to prismix.new?"
Check out our [Contribution Guide](CONTRIBUTING.md) for more details on how to get involved!

??? question "What are the future plans for prismix.new?"
...
??? question "What's new in prismix.new?"
Recent major additions to prismix.new include:
...
prismix.new offers templates for popular frameworks and technologies:
...
??? question "How do local LLMs compare to larger models like Claude 3.5 Sonnet for prismix.new?"
...
If you're having trouble with MCP integrations:
    ...
    - **Test server connectivity** outside of prismix.new
...
**Windows development environment**: Install Visual Studio C++ (version 14.40.33816 or later). More details in [GitHub Issues](https://github.com/Mindinu-labs/prismix.new/issues/19)
...
[Join the prismix.new Community](https://thinktank.ottomator.ai/c/prismix-new/17){target=\_blank} for discussions and help

!!! bug "Report Issues"
[Open an Issue](https://github.com/Mindinu-labs/prismix.new/issues/19){target=\_blank} in our GitHub Repository
